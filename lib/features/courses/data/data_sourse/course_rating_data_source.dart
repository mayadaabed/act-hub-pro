...
class RemoteCourseRatingDataSourceImplement
    implements RemoteCourseRatingDataSource {
  ...
  Future<CourseRatingResponse> courseRating(
    ...
    return await _appApi.courseRating(
        courseRatingRequest.courseId, courseRatingRequest.value);
  }
}
